...
export default function Experience() {
  ...
  return (
    <section
      ref={ref}
      id="experience"
      className="min-h-screen lg:min-h-[80vh] bg-[var(--navy)] flex items-center justify-center px-4 sm:px-8 md:px-12 lg:px-20 xl:px-32"
    >
      <div className="max-w-[650px] md:max-w-screen-md w-full text-center bg-[var(--navy)] p-6">
