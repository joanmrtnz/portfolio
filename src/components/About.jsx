      ...
      <div className="section-readable w-full max-w-[980px] text-center p-6 sm:p-8 md:p-10">
        ...
        <div className="text-left flex flex-col">
          ...
          <div className="font-mono sm:max-w-[250px] mx-auto md:max-w-none md:mx-0">
            <ol className={`list-disc text-base sm:text-lg text-[var(--green)] grid grid-cols-2 gap-x-6 gap-y-3 pl-6 mt-5 transition-opacity duration-700 delay-800 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}>
