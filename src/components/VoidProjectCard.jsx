          ...
          {isMobile ? (
                ...
                <ul className="mt-2 flex flex-wrap">
                  {[...Array(5)].map((_, index) => (
                    <li key={index} className="mr-1.5 mt-2">
                      <div className="min-h-[25px] backdrop-blur-lg bg-[var(--white)]/5 flex items-center rounded-full px-3 py-1 leading-5 animate-pulse"></div>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <>
              ...
              <div className="flex justify-center md:justify-start mb-3 mr-1">
                <p className="backdrop-blur-lg bg-[var(--white)]/5 min-w-[250px] min-h-[200px] sm:max-w-[350px] md:max-w-none rounded-lg"></p>
              </div>
            </>
          )}
